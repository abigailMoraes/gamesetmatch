...
public class TournamentService {
    ...
    public Optional<Tournament> getTournamentInfoByMatchID(int matchID) {
        Optional<Match> query = matchRepository.findById(matchID);
        Match match = null;
        match = query.get();
        Round round = null;
        Optional<Round> roundIDQuery = roundRepository.findById(match.getRoundID());
        round = roundIDQuery.get();
        return tournament.findById(round.getTournamentID());
    }
}
